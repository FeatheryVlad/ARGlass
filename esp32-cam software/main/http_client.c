...
void http_rest_with_url(void)
{
  ...
  esp_http_client_set_url(client, "http://192.168.1.104:8082/protocol");
  esp_http_client_set_method(client, HTTP_METHOD_POST);
  ...
  ////PUT
  //esp_http_client_set_url(client, "http://"CONFIG_ESP_HTTP_ENDPOINT"/put");
  ...
  ////PATCH
  //esp_http_client_set_url(client, "http://"CONFIG_ESP_HTTP_ENDPOINT"/patch");
  ...
  ////DELETE
  //esp_http_client_set_url(client, "http://"CONFIG_ESP_HTTP_ENDPOINT"/delete");
  ...
  ////HEAD
  //esp_http_client_set_url(client, "http://"CONFIG_ESP_HTTP_ENDPOINT"/get");
...
//   */
//  esp_http_client_config_t config = {
//    .url = "http://user:passwd@"CONFIG_ESP_HTTP_ENDPOINT"/basic-auth/user/passwd",
//    .event_handler = _http_event_handler,
...
//{
//  esp_http_client_config_t config = {
//    .url = "http://user:passwd@"CONFIG_ESP_HTTP_ENDPOINT"/digest-auth/auth/user/passwd/MD5/never",
//    .event_handler = _http_event_handler,
//  };
//  esp_http_client_handle_t client = esp_http_client_init(&config);
//  esp_err_t err = esp_http_client_perform(client);
...
//{
//  esp_http_client_config_t config = {
//    .url = "http://"CONFIG_ESP_HTTP_ENDPOINT"/relative-redirect/3",
//    .event_handler = _http_event_handler,
//  };
//  esp_http_client_handle_t client = esp_http_client_init(&config);
//  esp_err_t err = esp_http_client_perform(client);
...
//{
//  esp_http_client_config_t config = {
//    .url = "http://"CONFIG_ESP_HTTP_ENDPOINT"/absolute-redirect/3",
//    .event_handler = _http_event_handler,
//  };
//  esp_http_client_handle_t client = esp_http_client_init(&config);
//  esp_err_t err = esp_http_client_perform(client);
...
//{
//  esp_http_client_config_t config = {
//    .url = "http://"CONFIG_ESP_HTTP_ENDPOINT"/redirect-to?url=https://www.howsmyssl.com",
//    .event_handler = _http_event_handler,
//    .cert_pem = howsmyssl_com_root_cert_pem_start,
//  };
//  esp_http_client_handle_t client = esp_http_client_init(&config);
...
//{
//  esp_http_client_config_t config = {
//    .url = "http://"CONFIG_ESP_HTTP_ENDPOINT"/stream-bytes/8912",
//    .event_handler = _http_event_handler,
//  };
//  esp_http_client_handle_t client = esp_http_client_init(&config);
//  esp_err_t err = esp_http_client_perform(client);
...
//  }
//  esp_http_client_config_t config = {
//    .url = "http://"CONFIG_ESP_HTTP_ENDPOINT"/get",
//  };
//  esp_http_client_handle_t client = esp_http_client_init(&config);
//  esp_err_t err;
...
//  config.url = "https://"CONFIG_ESP_HTTP_ENDPOINT"/get";
...
//  // POST Request
//  const char *post_data = "{\"field1\":\"value1\"}";
//  esp_http_client_set_url(client, "http://"CONFIG_ESP_HTTP_ENDPOINT"/post");
//  esp_http_client_set_method(client, HTTP_METHOD_POST);
//  esp_http_client_set_header(client, "Content-Type", "application/json");
